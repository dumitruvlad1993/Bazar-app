    ...
    <div className='w-full h-auto overflow-x-hidden'>
      <div className='h-[650px] w-screen relative'>
        ...
        className='w-[400vw] h-full flex transition-transform duration-1000'>
            <img className="w-screen h-full object-fill" src={data[0]} alt="ImageOne" loading='priority'></img>
            <img className="w-screen h-full object-fill" src={data[1]} alt="ImageTwo" ></img>
            <img className="w-screen h-full object-fill" src={data[2]} alt="ImageThree" ></img>
            <img className="w-screen h-full object-fill" src={data[3]} alt="ImageFour" ></img>
        </div>
